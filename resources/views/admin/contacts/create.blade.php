                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nin" class="form-control @error('nin') is-invalid @enderror" id="nin" value="{{ old('nin') }}">
                                @error('nin')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="insurance_number" class="form-control @error('insurance_number') is-invalid @enderror" id="insurance_number" value="{{ old('insurance_number') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" name="salary" class="form-control @error('salary') is-invalid @enderror" id="salary" value="{{ old('salary') }}" required>
                                        @error('salary')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="managed_by" id="managed_by" class="form-control select2-single @error('managed_by') is-invalid @enderror">
                            ...
                            @foreach($contacts as $c)
                                <option value="{{ $c->id }}" {{ old('managed_by') == $c->id ? 'selected' : '' }}>
                                    {{ $c->full_name }}
                                </option>
                            @endforeach
                        </select>
