...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ __('actions.edit') }}: {{ $product->name }}</h3>
    </div>
    <form action="{{ route('products.update', $product) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="unit_price" id="unit_price" class="form-control @error('unit_price') is-invalid @enderror" value="{{ old('unit_price', $product->unit_price) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="number" name="alert_threshold" id="alert_threshold" class="form-control @error('alert_threshold') is-invalid @enderror" value="{{ old('alert_threshold', $product->alert_threshold) }}" required>
